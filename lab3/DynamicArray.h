...
class DynamicArray {
    ...
    public:
        ...
        bool findFirstOfWithStartingPoint(int value, unsigned int* index, unsigned int startingPoint);
        // find the last occurrence of "value" in the array. Return false if the value is not found
        bool findLastOfWithStartingPoint(int value, unsigned int* index, unsigned int startingPoint); 
